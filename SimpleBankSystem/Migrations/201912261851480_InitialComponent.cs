    ...
    public partial class InitialComponent : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CurentAccountID = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ...
                        Value = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Ballance = c.Decimal(nullable: false, precision: 18, scale: 2),
                        CurrenciesTableID = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ...
                        Value = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Ballance = c.Decimal(nullable: false, precision: 18, scale: 2),
                        CurrentAccountID = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
            ...
            CreateTable(
                ...
                c => new
                    {
                        LocationsID = c.Guid(nullable: false),
                        JobsID = c.Guid(nullable: false),
                    })
